...
/**
 * One row's cover picker. Its own little component (instead of inline
 * in the table) just so it can hold its own "uploading" state without
 * that state needing to track which row it belongs to.
 */
...
/**
 * A product with real history (sold, rented, or borrowed) is never
 * silently destroyed - the backend blocks that and returns a clear
 * message (see ProductServiceImpl.deleteProduct), shown here instead of
 * removing the row.
 */
