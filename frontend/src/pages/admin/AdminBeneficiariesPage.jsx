  ...
  return (
    <div>
      ...
      <p className="muted mb-6 max-w-[65ch]">
        Every royalty share recorded so far, one row per beneficiary per sale or borrow.
      </p>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            {rows.map((r) => (
              <tr key={r.prodbenId} style={{ borderBottom: 'var(--rule-hair) solid var(--color-rule)' }}>
